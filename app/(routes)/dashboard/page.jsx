  ...
  return (
    <div className="p-8">
      ...
      <p className="text-gray-500">
        Let's take charge of your finances. Let's manage your expenses
        effectively.
      </p>
      <CardInfo budgetList={budgetList} />
      <div className="grid grid-cols-1 md:grid-cols-3 mt-9 gap-5">
        ...
        <div className="grid gap-5">
          <h2 className="font-bold text-lg">Newst Budgets</h2>
